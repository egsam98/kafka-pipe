defmodule KafkaPipeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KafkaPipeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KafkaPipeWeb.Gettext, "errors", msg, opts)
    end
  end
